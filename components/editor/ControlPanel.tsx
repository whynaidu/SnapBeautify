    ...
    return (
        <div className="w-80 bg-zinc-900 border-l border-zinc-800 overflow-y-auto">
            <Tabs defaultValue="background" className="w-full">
                <TabsList className="w-full grid grid-cols-4 bg-zinc-900 border-b border-zinc-800 rounded-none h-12 p-0">
                    <TabsTrigger
                        value="background"
                        className="rounded-none data-[state=active]:bg-zinc-800 data-[state=active]:shadow-none h-full"
                    >
